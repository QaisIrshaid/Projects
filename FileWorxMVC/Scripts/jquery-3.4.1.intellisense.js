intellisense.annotate(jQuery, {
  ...
  'get': function() {
    /// <signature>
    ///   <summary>LoadObjects data from the server using a HTTP GET request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
  ...
  'getJSON': function() {
    /// <signature>
    ///   <summary>LoadObjects JSON-encoded data from the server using a GET HTTP request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
  ...
  'getScript': function() {
    /// <signature>
    ///   <summary>LoadObjects a JavaScript file from the server using a GET HTTP request, then execute it.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
  ...
  'post': function() {
    /// <signature>
    ///   <summary>LoadObjects data from the server using a HTTP POST request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="data" type="">A plain object or string that is sent to the server with the request.</param>
